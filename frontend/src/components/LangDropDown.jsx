...
const LangDropDown = forwardRef(({ setCurrentLang, setExpanded }, ref) => {
  ...
  return (
    <div className="absolute top-full border-border border rounded-xl overflow-clip">
      ...
      />
      <div className=" max-h-[400px] bg-bg overflow-auto customScroll">
        {googleTranslateLanguages.map((lang) =>
          lang.toLocaleLowerCase().startsWith(filter.toLocaleLowerCase()) ? (
            <div
              key={lang}
              className="p-1 px-2 hover:bg-bg-light cursor-pointer"
              onClick={() => {
                handleClick(lang);
                setExpanded(false);
              }}
